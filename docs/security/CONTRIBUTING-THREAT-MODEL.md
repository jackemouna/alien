---
summary: "How to contribute to the Alien threat model"
...
Thanks for helping make Alien more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.

## Ways to contribute

### Add a threat

Spotted an attack vector or risk we haven't covered? Open an issue on [alien/trust](https://github.com/alien/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.

**Helpful to include (but not required):**

- The attack scenario and how it could be exploited
- Which parts of Alien are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
- How severe you think it is (low / medium / high / critical)
- Any links to related research, CVEs, or real-world examples

We'll handle the ATLAS mapping, threat IDs, and risk assessment during review. If you want to include those details, great - but it's not expected.

> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, see our [Trust page](https://trust.alien.ai) for responsible disclosure instructions.
...
- [Alien Threat Model](/security/THREAT-MODEL-ATLAS)

## Contact

- **Security vulnerabilities:** See our [Trust page](https://trust.alien.ai) for reporting instructions
- **Threat model questions:** Open an issue on [alien/trust](https://github.com/alien/trust/issues)
- **General chat:** Discord #security channel

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Alien security hall of fame for significant contributions.
