---
summary: Machine-checked security models for Alien's highest-risk paths.
...
This page tracks Alien's **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Alien enforces its
...
**What this is not (yet):** a proof that "Alien is secure in all respects" or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/alien-formal-models](https://github.com/vignesh07/alien-formal-models).
...
```bash
git clone https://github.com/vignesh07/alien-formal-models
cd alien-formal-models
