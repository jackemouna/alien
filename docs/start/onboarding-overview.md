---
summary: "Overview of Alien onboarding options and flows"
read_when:
...
Alien has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `alien onboard`                     | Launch the app            |
...
CLI command docs: [`alien onboard`](/cli/onboard)

## macOS app onboarding

Open the Alien app. The first-run wizard walks you through the same steps
