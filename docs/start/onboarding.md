---
summary: "First-run setup flow for Alien (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Alien">
...
<Step title="CLI">
  ...
  The app can install the global `alien` CLI via npm, pnpm, or bun.
