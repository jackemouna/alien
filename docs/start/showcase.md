...
<Card title="Community showcase reel" href="https://www.youtube.com/watch?v=mMSKQvlmFuQ">
  A faster pass across real projects, surfaces, and workflows built around Alien.
</Card>
...
OpenCode finishes the change, opens a PR, Alien reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Alien PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked "Robby" (@alien) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="Alien building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Alien.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Alien instances.
</Card>
...
CLI for Linear that integrates with agentic workflows (Claude Code, Alien). Manage issues, projects, and workflows from the terminal.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Alien takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via Alien" />
</Card>

<Card title="Pretty sky camera shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Triggered by a roof camera: ask Alien to snap a sky photo whenever it looks pretty. It designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by Alien" />
</Card>

<Card title="Visual morning briefing scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `telegram`

A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Alien persona.
</Card>
...
Alien connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `todoist` `skill` `telegram`

Automated Todoist tasks and had Alien generate the skill directly in Telegram chat.
</Card>
...
Chinese learning engine with pronunciation feedback and study flows via Alien.
...
Vapi voice assistant to Alien HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make Alien easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/alien-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`

Alien gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix packaging" icon="snowflake" href="https://github.com/alien/nix-alien">
  **@alien** • `nix` `packaging` `deployment`

Batteries-included nixified Alien configuration for reproducible deployments.
</Card>
...
The physical-world side of Alien: homes, sensors, cameras, vacuums, and other devices.
...
Nix-native home automation with Alien as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Alien ecosystem.
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @alien](https://x.com/alien).
  </Step>
