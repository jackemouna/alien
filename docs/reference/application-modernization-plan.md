...
read_when:
  - Planning a broad Alien application modernization pass
...
modernization task. If adopting this guidance as a repo-local Alien skill,
create `.agents/skills/alien-frontend/SKILL.md` first, keep the frontmatter
