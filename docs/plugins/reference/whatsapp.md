---
summary: "Adds the WhatsApp channel surface for sending and receiving Alien messages."
read_when:
...
Adds the WhatsApp channel surface for sending and receiving Alien messages.

## Distribution

- Package: `@alien/whatsapp`
