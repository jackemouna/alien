---
summary: "Testing utilities and patterns for Alien plugins"
...
Reference for test utilities, patterns, and lint enforcement for Alien
plugins.
...
**Plugin API mock import:** `alien/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `alien/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `alien/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `alien/plugin-sdk/channel-test-helpers`

**Channel target test import:** `alien/plugin-sdk/channel-target-testing`

**Plugin contract import:** `alien/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `alien/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `alien/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `alien/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `alien/plugin-sdk/test-env`

**Generic fixture import:** `alien/plugin-sdk/test-fixtures`

**Node builtin mock import:** `alien/plugin-sdk/test-node-mocks`

Prefer the focused subpaths below for new plugin tests. The broad
`alien/plugin-sdk/testing` barrel is legacy compatibility only.
...
import { installCommonResolveTargetErrorCases } from "alien/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "alien/plugin-sdk/agent-runtime-test-contracts";
...
import { registerSingleProviderPlugin } from "alien/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "alien/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "alien/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "alien/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "alien/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "alien/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Alien inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "alien/plugin-sdk/plugin-test-runtime";
```
...
Alien's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `alien/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `alien/plugin-sdk` root barrel is rejected
...
Alien uses Vitest with V8 coverage thresholds. For plugin tests:
