---
summary: "Contributor guide for adding a new shared capability to the Alien plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Alien core developers. If you are
...
Use this when Alien needs a new shared domain such as image generation, video generation, or some future vendor-backed feature area.
