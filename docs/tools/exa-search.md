...
Alien supports [Exa AI](https://exa.ai/) as a `web_search` provider. Exa
      ...
      exa: {
        config: {
          webSearch: {
            ...
            baseUrl: "https://api.exa.ai", // optional; Alien appends /search
          },
        },
      },
    },
...
should go through a compatible proxy or alternate Exa endpoint. Alien
