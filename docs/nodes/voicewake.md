...
Alien treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.alien/settings/voicewake.json`

Shape:

```json
{ "triggers": ["alien", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
