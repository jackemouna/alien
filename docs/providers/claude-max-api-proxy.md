...
<Steps>
  ...
  <Step title="Configure Alien">
    Point Alien at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Alien
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Alien integration with Claude CLI or API keys.
  </Card>
