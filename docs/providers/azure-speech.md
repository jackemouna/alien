---
summary: "Azure AI Speech text-to-speech for Alien replies"
read_when:
...
Azure Speech is an Azure AI Speech text-to-speech provider. In Alien it
...
Alien uses the Azure Speech REST API directly with SSML and sends the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Alien synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; Alien derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. Alien
