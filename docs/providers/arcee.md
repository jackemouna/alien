...
title: "Arcee AI"
read_when:
  - You want to use Arcee AI with Alien
...
<Tabs>
  <Tab title="Direct (Arcee platform)">
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        alien onboard --auth-choice arceeai-api-key
        ```
      </Step>
  ...
  <Tab title="Via OpenRouter">
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        alien onboard --auth-choice arceeai-openrouter
        ```
      </Step>
      <Step title="Set a default model">
        ```json5
...
Alien currently ships this bundled Arcee catalog:
...
<AccordionGroup>
  ...
  <Accordion title="OpenRouter routing">
    ...
    Alien handles routing transparently based on your auth choice. See the
