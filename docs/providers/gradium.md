---
summary: "Use Gradium text-to-speech in Alien"
read_when:
...
Gradium is a bundled text-to-speech provider for Alien. It can generate normal audio replies, voice-note-compatible Opus output, and 8 kHz u-law audio for telephony surfaces.

## Setup

Create a Gradium API key, then expose it to Alien:
