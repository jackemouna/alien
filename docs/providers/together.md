...
title: "Together AI"
read_when:
  - You want to use Together AI with Alien
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    alien onboard --auth-choice together-api-key
    ```
  </Step>
...
Alien ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.alien/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `alien models list --provider together`
