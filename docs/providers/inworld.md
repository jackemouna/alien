---
summary: "Inworld streaming text-to-speech for Alien replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Alien it
...
Alien posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Alien synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Alien asks Inworld for `OGG_OPUS` so the audio plays as a native
