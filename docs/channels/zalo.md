...
Zalo ships as a bundled plugin in current Alien releases, so normal packaged
...
- Install via CLI: `alien plugins install @alien/zalo`
- Pinned version: `alien plugins install @alien/zalo@2026.5.2`
- Or from a source checkout: `alien plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Alien behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `alien pairing list zalo`
  - `alien pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Alien.
...
- Example: `alien message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `alien channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `alien logs --follow`
