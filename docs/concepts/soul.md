---
summary: "Use SOUL.md to give your Alien agent an actual voice instead of generic assistant sludge"
read_when:
...
Alien injects it on normal sessions, so it has real weight. If your agent
...
For Alien, `SOUL.md` is that layer.
...
Path fixed for Alien workspaces: use `SOUL.md`, not `http://SOUL.md`.
...
<CardGroup cols={2}>
  <Card title="Agent workspace" href="/concepts/agent-workspace" icon="folder-open">
    Workspace files Alien injects into the system prompt.
  </Card>
