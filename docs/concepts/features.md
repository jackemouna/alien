---
summary: "Alien capabilities across channels, routing, media, and UX."
read_when:
  - You want a full list of what Alien supports
title: "Features"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Plugins" href="/tools/plugin" icon="plug">
    Bundled and third-party plugins that extend Alien.
  </Card>
</CardGroup>
