...
Alien also builds a separate idempotent replay view for sessions that
...
Alien auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Alien does not override them.
