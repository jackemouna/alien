...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as ALIEN_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                ALIEN_OAUTH_DIR: path.join(stateDir, "credentials"),
                ALIEN_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
