...
execution:
  ...
  config:
    firstPrompt: "@alien Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@alien Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
