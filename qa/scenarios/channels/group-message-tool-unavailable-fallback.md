...
successCriteria:
  ...
  - Alien falls back to automatic delivery and posts the marker to the same group.
docsRefs:
...
execution:
  ...
  config:
    ...
    prompt: "@alien qa group message unavailable fallback check. exact marker: `QA-GROUP-FALLBACK-OK`"
