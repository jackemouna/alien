...
- use `pnpm alien qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Alien QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Alien repo from source + docs before acting.
