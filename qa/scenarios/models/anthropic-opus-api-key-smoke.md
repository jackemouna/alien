...
execution:
  kind: flow
  summary: Run with `pnpm alien qa suite --provider-mode live-frontier --model anthropic/claude-opus-4-6 --alt-model anthropic/claude-opus-4-6 --scenario anthropic-opus-api-key-smoke`.
  config:
