...
Maintenance update for the current Alien development release.
...
Maintenance update for the current Alien release.

## 2026.4.19 - 2026-04-19

Maintenance update for the current Alien beta release.
...
First App Store release of Alien for iPhone. Pair with your Alien Gateway to use chat, voice, sharing, and device actions from iOS.
