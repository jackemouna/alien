...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AlienPhotosLatestParams) async throws -> AlienPhotosLatestPayload {
        ...
        return AlienPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AlienPhotoPayload
    {
