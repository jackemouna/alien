...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.alien.gateway"
    private static let nodeService = "ai.alien.node"
    private static let talkService = "ai.alien.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.alien.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.alien.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("alien-gateway.log")
    }
