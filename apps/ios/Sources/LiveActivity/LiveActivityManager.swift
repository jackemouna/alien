...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.alien.ios", category: "LiveActivity")
    private var currentActivity: Activity<AlienActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = AlienActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<AlienActivityAttributes>.activities
    ...
    private func updateCurrent(state: AlienActivityAttributes.ContentState) {
    ...
    private func connectingState() -> AlienActivityAttributes.ContentState {
        AlienActivityAttributes.ContentState(
    ...
    private func idleState() -> AlienActivityAttributes.ContentState {
        AlienActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> AlienActivityAttributes.ContentState {
        AlienActivityAttributes.ContentState(
