...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "alien devices approve req-123",
            docsURLString: "https://docs.alien.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "alien devices approve req-123")
        #expect(error.docsURLString == "https://docs.alien.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "alien devices approve req-123")
    }
