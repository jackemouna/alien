...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: AlienProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AlienProtocol.AnyCodable(identity.deviceId),
            "publicKey": AlienProtocol.AnyCodable(publicKey),
            "signature": AlienProtocol.AnyCodable(signature),
            "signedAt": AlienProtocol.AnyCodable(signedAtMs),
            "nonce": AlienProtocol.AnyCodable(nonce),
        ]
    }
}
