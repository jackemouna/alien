...
public enum AlienTalkCommand: String, Codable, Sendable {
...
public struct AlienTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AlienTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
