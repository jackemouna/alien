...
public enum AlienCanvasA2UICommand: String, Codable, Sendable {
...
public struct AlienCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AlienCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
