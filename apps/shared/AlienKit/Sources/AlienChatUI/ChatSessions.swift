...
public struct AlienChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct AlienChatSessionsDefaults: Codable, Sendable {
...
public struct AlienChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct AlienChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: AlienChatSessionsDefaults?
    public let sessions: [AlienChatSessionEntry]
    ...
    public init(
        ...
        sessions: [AlienChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
