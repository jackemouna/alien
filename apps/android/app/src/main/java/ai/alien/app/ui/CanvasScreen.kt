...
fun CanvasScreen(
  ...
  AndroidView(
    ...
    factory = {
      ...
      if (isDebuggable) {
        Log.d("AlienWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("AlienWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("AlienWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("AlienWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "alienCanvasA2UIAction"
