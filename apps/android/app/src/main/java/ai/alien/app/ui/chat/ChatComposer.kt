...
import ai.alien.app.ui.mobileAccentBorderStrong
...
import ai.alien.app.ui.mobileHeadline
import ai.alien.app.ui.mobileSurface
import ai.alien.app.ui.mobileText
import ai.alien.app.ui.mobileTextSecondary
import ai.alien.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.alien.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.alien.app.ui.mobileFontFamily,
