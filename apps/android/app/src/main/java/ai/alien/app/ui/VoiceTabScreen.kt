...
import ai.alien.app.VoiceCaptureMode
import ai.alien.app.voice.VoiceConversationEntry
import ai.alien.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Alien is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
