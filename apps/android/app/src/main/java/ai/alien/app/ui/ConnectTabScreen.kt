    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            Text(
              "Approve this phone on the gateway. Alien retries automatically while this screen stays open.",
              style = mobileCallout,
              color = mobileTextSecondary,
            )
          ...
          Text("Alien Android ${openClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("alien qr --setup-code-only")
          CommandBlock("alien qr --json")
          Text(
