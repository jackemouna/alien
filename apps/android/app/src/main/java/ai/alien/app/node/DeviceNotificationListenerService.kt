...
import ai.alien.app.NotificationBurstLimiter
import ai.alien.app.SecurePrefs
import ai.alien.app.allowsPackage
import ai.alien.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("alien.secure", Context.MODE_PRIVATE)
