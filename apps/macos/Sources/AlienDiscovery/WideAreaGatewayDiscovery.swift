...
enum WideAreaGatewayDiscovery {
        ...
        context: DiscoveryContext = .live) -> [WideAreaGatewayBeacon]
    {
        ...
        for raw in ptrLines {
            ...
            let suffix = "._alien-gw._tcp.\(domainTrimmed)"
    ...
    {
        guard let domain = AlienBonjour.wideAreaGatewayServiceDomain else { return nil }
        let domainTrimmed = domain.trimmingCharacters(in: CharacterSet(charactersIn: "."))
        let probeName = "_alien-gw._tcp.\(domainTrimmed)"
