...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.alien", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Alien windows, but below the system’s pop-up menus.
