...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.alien", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.alien", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AlienChatMessage] = messages.compactMap { item in
