...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.alien", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AlienConfigFile.defaultWorkspaceURL() }
