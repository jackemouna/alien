...
enum UIStrings {
    static let welcomeTitle = "Welcome to Alien"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "alien.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AlienChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g alien@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AlienChatViewModel(
