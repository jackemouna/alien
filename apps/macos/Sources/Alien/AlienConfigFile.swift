...
enum AlienConfigFile {
    private static let logger = Logger(subsystem: "ai.alien", category: "config")
    ...
    static func url() -> URL {
        AlienPaths.configURL
    }

    static func stateDirURL() -> URL {
        AlienPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AlienPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-alien-config-file",
            "event": "config.write",
