...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/alien/alien") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/alien/alien")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://alien.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AlienBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AlienBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AlienGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AlienGitCommit") as? String) ??
            "unknown"
    }
