...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .alienSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AlienPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AlienPaths.stateDirURL.path
...
extension Notification.Name {
    static let alienSelectSettingsTab = Notification.Name("alienSelectSettingsTab")
}
