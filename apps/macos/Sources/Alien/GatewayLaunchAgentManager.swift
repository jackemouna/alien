...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.alien", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".alien/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.alienCommand(
            subcommand: "gateway",
