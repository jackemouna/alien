...
func runWizardCommand(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Usage:
          alien-mac wizard [--url <ws://host:port>] [--token <token>] [--password <password>]
...
actor GatewayWizardClient {
    ...
    private func sendConnect() async throws {
        ...
        let client: [String: ProtoAnyCodable] = [
            ...
            "displayName": ProtoAnyCodable(Host.current().localizedName ?? "Alien macOS Wizard CLI"),
