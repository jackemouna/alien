...
struct MacGatewayChatTransportMappingTests {
    @Test func `snapshot maps to health`() {
        let snapshot = Snapshot(
            presence: [],
            health: AlienProtocol.AnyCodable(["ok": AlienProtocol.AnyCodable(false)]),
    ...
    @Test func `health event maps to health`() {
        let frame = EventFrame(
            type: "event",
            event: "health",
            payload: AlienProtocol.AnyCodable(["ok": AlienProtocol.AnyCodable(true)]),
            seq: 1,
            stateversion: nil)
    ...
    @Test func `chat event maps to chat`() {
        let payload = AlienProtocol.AnyCodable([
            "runId": AlienProtocol.AnyCodable("run-1"),
            "sessionKey": AlienProtocol.AnyCodable("main"),
            "state": AlienProtocol.AnyCodable("final"),
        ])
    ...
    @Test func `session message event maps to session message`() {
        let payload = AlienProtocol.AnyCodable([
            "sessionKey": AlienProtocol.AnyCodable("agent:main:main"),
            "messageId": AlienProtocol.AnyCodable("msg-1"),
            "messageSeq": AlienProtocol.AnyCodable(7),
            "message": AlienProtocol.AnyCodable([
                "role": AlienProtocol.AnyCodable("user"),
                "content": AlienProtocol.AnyCodable([
                    AlienProtocol.AnyCodable([
                        "type": AlienProtocol.AnyCodable("text"),
                        "text": AlienProtocol.AnyCodable("spoken transcript"),
                    ]),
                ]),
                "timestamp": AlienProtocol.AnyCodable(1234.5),
            ]),
        ])
    ...
    @Test func `unknown event maps to nil`() {
        let frame = EventFrame(
            type: "event",
            event: "unknown",
            payload: AlienProtocol.AnyCodable(["a": AlienProtocol.AnyCodable(1)]),
            seq: 1,
            stateversion: nil)
        let mapped = MacGatewayChatTransport.mapPushToTransportEvent(.event(frame))
        #expect(mapped == nil)
