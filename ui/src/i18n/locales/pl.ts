...
export const pl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z alien dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą alien models auth",
