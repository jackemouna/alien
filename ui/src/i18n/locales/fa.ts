...
export const fa: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "روی موبایل هستید؟ URL کامل (شامل #token=...) را از alien dashboard --no-open روی دسکتاپ خود کپی کنید.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — با alien models auth دوباره احراز هویت کنید",
