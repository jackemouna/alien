...
export const en: TranslationMap = {
  ...
  tabs: {
    ...
    debug: "Debug",
    logs: "Logs",
    dreams: "Background reflection",
  },
  subtitles: {
    agents: "Configure each AI worker's tools and identity.",
    overview: "How your Alien is set up and how it's doing right now.",
    channels: "Connect Slack, Discord, Telegram, and other chat surfaces.",
    instances: "Computers and phones currently talking to this gateway.",
    sessions: "Active conversations and per-session overrides.",
    usage: "How much you've spent this week — by model, by session.",
    cron: "Recurring jobs your team runs on a schedule.",
    orchestrator: "One-shot research briefs your AI team writes for you.",
    projects: "Your AI team's workspaces — give them a goal, watch the work happen.",
    skills: "Add capabilities to your team (browse, code, search, …).",
    nodes: "Phones and laptops paired with this Alien.",
    chat: "Plain chat surface for direct conversations with your Alien.",
    config: "Direct edit of the gateway config file.",
    communications: "Where your Alien talks — channels, messages, audio.",
    appearance: "Theme, layout, and the welcome wizard.",
    automation: "Commands, hooks, schedules, and plugins.",
    infrastructure: "Gateway server, browser, and media settings.",
    aiAgents: "Pick your models, store API keys, manage memory.",
    debug: "Internal state, events, and RPC console.",
    logs: "Live gateway logs.",
    dreams: "How your Alien thinks between sessions (memory + reflection).",
  },
  overview: {
    access: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from alien dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with alien models auth",
