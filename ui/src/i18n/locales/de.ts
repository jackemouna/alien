...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.alien/alien.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von alien dashboard --no-open auf Ihrem Desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit alien models auth erneut authentifizieren",
