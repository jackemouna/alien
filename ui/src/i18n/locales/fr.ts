...
export const fr: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis alien dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — réauthentifiez-vous avec alien models auth",
