...
export class AlienModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "alien-modal-dialog-label" : "";
    const descriptionId = this.description ? "alien-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("alien-modal-dialog")) {
  customElements.define("alien-modal-dialog", AlienModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "alien-modal-dialog": AlienModalDialog;
  }
}
