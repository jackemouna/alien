...
export function renderOverview(props: OverviewProps) {
      ...
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ${pairingState.requestId
            ? html`<span class="mono">alien devices approve ${pairingState.requestId}</span
                ><br />`
            : nothing}
          <span class="mono">alien devices list</span>
        </div>
        <div style="margin-top: 6px; font-size: 12px;">${t("overview.pairing.mobileHint")}</div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.alien.ai/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">alien dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">alien doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "alien dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.alien.ai/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.alien.ai/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.alien.ai/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px; min-width: 0;">
                    <input
                      ...
                      placeholder="ALIEN_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
              ...
              <div class="login-gate__help" style="margin-top: 16px;">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ...
                    ${renderConnectCommand("alien gateway run")}
                  </li>
                  <li>
                    ${t("overview.connection.step2")} ${renderConnectCommand("alien dashboard")}
                  </li>
                  <li>${t("overview.connection.step3")}</li>
                  <li>
                    ${t("overview.connection.step4")}<code
                      >alien doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
