...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/alien");
      expect(html).toContain('<a href="http://github.com/alien"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Alien中文](https://docs.alien.ai)");
      expect(html).toContain('href="https://docs.alien.ai"');
      expect(html).toContain("Alien中文</a>");
    });
