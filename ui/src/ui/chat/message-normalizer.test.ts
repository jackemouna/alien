...
describe("message-normalizer", () => {
  describe("normalizeMessage", () => {
      ...
      expect(result.content).toEqual([
        { type: "text", text: "Here." },
        {
          ...
          preview: {
            ...
            render: "url",
            viewId: "cv_status",
            url: "/__alien__/canvas/documents/cv_status/index.html",
            title: "Status",
            preferredHeight: 320,
          },
          rawText: null,
    ...
    it("keeps spaced local filenames together instead of leaking suffix text", () => {
      const result = normalizeMessage({
        role: "assistant",
        content: "MEDIA:/tmp/alien/shinkansen kato - Google Shopping.pdf",
      });
      ...
      expect(result.content).toEqual([
        {
          type: "attachment",
          attachment: {
            url: "/tmp/alien/shinkansen kato - Google Shopping.pdf",
            kind: "document",
