...
const SYNTHETIC_TRANSCRIPT_REPAIR_RESULT =
  "[alien] missing tool result in session history; inserted synthetic error result for transcript repair.";
...
function hasTranscriptMeta(message: unknown): boolean {
  return Boolean(
    ...
    (message as { __alien?: unknown }).__alien &&
    typeof (message as { __alien?: unknown }).__alien === "object",
  );
}
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/alien/alien/issues/1909
