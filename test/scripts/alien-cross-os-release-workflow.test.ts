...
const WORKFLOW_PATH = ".github/workflows/alien-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-alien-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-alien-cross-os-release-checks.sh";
