...
const WORKER_RUNTIME_STATE = Symbol.for("alien.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("alien.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("alien.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: AlienConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
