...
declare global {
  ...
  var __ALIEN_TEST_REFRESH_OPENAI_CODEX_TOKEN__: ((...args: unknown[]) => unknown) | undefined;
}
...
vi.mock("@mariozechner/pi-ai/oauth", () => ({
  ...
  refreshOpenAICodexToken: vi.fn((...args: unknown[]) =>
    globalThis.__ALIEN_TEST_REFRESH_OPENAI_CODEX_TOKEN__?.(...args),
  ),
}));
...
// arbitrary ALIEN_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
