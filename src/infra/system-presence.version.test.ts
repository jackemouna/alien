  ...
  return withEnvAsync(
    {
      ...
      ALIEN_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when ALIEN_VERSION is not set", async () => {
  ...
  it("prefers ALIEN_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over ALIEN_SERVICE_VERSION when ALIEN_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        ALIEN_VERSION: " ",
        ALIEN_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when ALIEN_VERSION and ALIEN_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        ALIEN_VERSION: " ",
        ALIEN_SERVICE_VERSION: "\t",
