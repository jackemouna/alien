...
describe("resolveEffectiveHomeDir", () => {
  it.each([
    {
      name: "prefers ALIEN_HOME over HOME and USERPROFILE",
      env: {
...
describe("resolveRequiredHomeDir", () => {
  it.each([
    ...
    {
      name: "returns a fully resolved path for ALIEN_HOME",
      env: { ALIEN_HOME: "/custom/home" } as NodeJS.ProcessEnv,
      homedir: () => "/fallback",
      expected: path.resolve("/custom/home"),
    },
    {
      name: "returns cwd when ALIEN_HOME is tilde-only and no fallback home exists",
      env: { ALIEN_HOME: "~" } as NodeJS.ProcessEnv,
      homedir: () => {
        throw new Error("no home");
      },
      expected: process.cwd(),
...
describe("resolveOsHomeDir", () => {
  it("ignores ALIEN_HOME and uses HOME", () => {
    expect(
      resolveOsHomeDir(
        {
          ALIEN_HOME: "/srv/alien-home",
  ...
  it.each([
    {
      ...
      expected: `${path.resolve("/srv/alien-home")}/x`,
    },
    {
      name: "expands exact ~ using explicit home",
      input: "~",
      opts: { home: " /srv/alien-home " },
      expected: "/srv/alien-home",
    },
    {
...
describe("resolveHomeRelativePath", () => {
  it.each([
    ...
    },
    {
      ...
      expected: path.resolve("/srv/alien-home/docs"),
    },
    {
...
describe("resolveOsHomeRelativePath", () => {
  it("expands tilde paths using the OS home instead of ALIEN_HOME", () => {
    expect(
