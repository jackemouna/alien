...
export const DEFAULT_RESTART_SUCCESS_CONTINUATION_MESSAGE =
  "The gateway restart completed successfully. Tell the user Alien restarted successfully and continue any pending work.";
...
export function formatDoctorNonInteractiveHint(
  ...
  return `Run: ${formatCliCommand("alien doctor --non-interactive", env)}`;
}
