...
import { openClawRootFs, openClawRootFsSync } from "./alien-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["alien"]);
...
export async function resolveAlienPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveAlienPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
...
export const __testing = {
  clearAlienPackageRootCaches(): void {
