...
describe("infra store", () => {
  describe("state migrations fs", () => {
    it("treats array session stores as invalid", async () => {
      await withTempDir("alien-session-store-", async (dir) => {
  ...
  describe("voicewake store", () => {
    it("returns defaults when missing", async () => {
      await withTempDir("alien-voicewake-", async (baseDir) => {
  ...
  describe("voicewake routing store", () => {
    it("returns defaults when missing", async () => {
      const baseDir = await fs.mkdtemp(path.join(os.tmpdir(), "alien-voicewake-routing-"));
