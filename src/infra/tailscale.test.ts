...
describe("tailscale helpers", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["ALIEN_TEST_TAILSCALE_BINARY", "NODE_ENV", "VITEST"]);
    process.env.ALIEN_TEST_TAILSCALE_BINARY = "tailscale";
  ...
  it("allows the test binary override in explicit test environments", () => {
    process.env.ALIEN_TEST_TAILSCALE_BINARY = "/tmp/test-tailscale";
  ...
  it("ignores the test binary override outside test environments", () => {
    process.env.ALIEN_TEST_TAILSCALE_BINARY = "/tmp/attacker-tailscale";
