...
const DEFAULT_VAPID_SUBJECT = "mailto:alien@localhost";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.ALIEN_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.ALIEN_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.ALIEN_VAPID_PRIVATE_KEY || undefined;
}
