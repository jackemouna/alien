...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): AlienConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): AlienConfig {
  return {
