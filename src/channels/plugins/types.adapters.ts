...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: AlienConfig) => string[];
  resolveAccount: (cfg: AlienConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: AlienConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: AlienConfig) => string;
  setAccountEnabled?: (params: {
    cfg: AlienConfig;
    accountId: string;
    enabled: boolean;
  }) => AlienConfig;
  deleteAccount?: (params: { cfg: AlienConfig; accountId: string }) => AlienConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: AlienConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AlienConfig) => string
  >;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AlienConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AlienConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AlienConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: AlienConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: AlienConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: AlienConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.alien.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: AlienConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: AlienConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: AlienConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: AlienConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: AlienConfig; accountId?: string | null }) =>
    | {
