...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: AlienConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: AlienConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: AlienConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: AlienConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: AlienConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: AlienConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: AlienConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: AlienConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: AlienConfig) => AlienConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: AlienConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: AlienConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: AlienConfig, policy: DmPolicy, accountId?: string) => AlienConfig;
