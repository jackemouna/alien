...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: AlienConfig): string | undefined {
  ...
  function listAccountIds(cfg: AlienConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AlienConfig): string {
