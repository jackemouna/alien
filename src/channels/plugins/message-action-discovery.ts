...
export function listChannelMessageActions(cfg: AlienConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: AlienConfig): ChannelMessageCapability[] {
