...
export type ChannelMessageSendTextContext<TConfig = AlienConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = AlienConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = AlienConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendAttemptContext<TConfig = AlienConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = AlienConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = AlienConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
