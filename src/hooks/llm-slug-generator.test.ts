...
vi.mock("../agents/agent-scope.js", () => ({
  ...
  resolveAgentWorkspaceDir: vi.fn(() => "/tmp/alien-agent"),
  resolveAgentDir: vi.fn(() => "/tmp/alien-agent/.alien-agent"),
  resolveAgentEffectiveModelPrimary: vi.fn((cfg: AlienConfig) => {
