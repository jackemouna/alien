/**
 * Hook system for Alien agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("alien.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("alien.internalHooksEnabled");
