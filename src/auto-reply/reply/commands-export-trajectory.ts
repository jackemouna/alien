...
import {
  buildCurrentAlienCliArgv,
  buildCurrentAlienCliCommand,
} from "./commands-alien-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.alien.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentAlienCliArgv(args),
    command: buildCurrentAlienCliCommand(args),
    displayCommand: ["alien", ...args].join(" "),
    encodedRequest,
    request,
  };
}
