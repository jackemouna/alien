...
function resolveMentionPatterns(cfg: AlienConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AlienConfig | undefined, agentId?: string): RegExp[] {
