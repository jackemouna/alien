...
const { buildStatusReplyMock, createAlienToolsMock, getChannelPluginMock, handleCommandsMock } =
  vi.hoisted(() => ({
    buildStatusReplyMock: vi.fn(),
    createAlienToolsMock: vi.fn(),
...
vi.mock("../../agents/alien-tools.runtime.js", () => ({
  createAlienTools: (...args: unknown[]) => createAlienToolsMock(...args),
}));
