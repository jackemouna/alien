...
function resolveAcpStreamCoalesceIdleMs(cfg: AlienConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AlienConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AlienConfig): AcpProjectionSettings {
