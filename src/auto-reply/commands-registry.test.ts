...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@alien", { botUsername: "alien" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@alien args", {
        botUsername: "alien",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "alien" })).toBe(
      "/help@otherbot",
    );
  });
