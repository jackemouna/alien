...
type ExecToolConfig = NonNullable<NonNullable<AlienConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<AlienConfig> {
