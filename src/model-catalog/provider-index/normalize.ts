...
import type {
  AlienProviderIndex,
  AlienProviderIndexPluginInstall,
  AlienProviderIndexPlugin,
  AlienProviderIndexProviderAuthChoice,
  AlienProviderIndexProvider,
} from "./types.js";

const ALIEN_PROVIDER_INDEX_VERSION = 1;
...
function normalizeInstall(value: unknown): AlienProviderIndexPluginInstall | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizePlugin(value: unknown): AlienProviderIndexPlugin | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizeOnboardingScopes(
  value: unknown,
): AlienProviderIndexProviderAuthChoice["onboardingScopes"] | undefined {
...
function normalizeAssistantVisibility(
  value: unknown,
): AlienProviderIndexProviderAuthChoice["assistantVisibility"] | undefined {
...
function normalizeAuthChoice(params: {
  ...
  providerName: string;
  value: unknown;
}): AlienProviderIndexProviderAuthChoice | undefined {
...
function normalizeAuthChoices(params: {
  ...
  providerName: string;
  value: unknown;
}): readonly AlienProviderIndexProviderAuthChoice[] | undefined {
  if (!Array.isArray(params.value)) {
    return undefined;
  }
  const choices = params.value
    .map((value) => normalizeAuthChoice({ ...params, value }))
    .filter((choice): choice is AlienProviderIndexProviderAuthChoice => Boolean(choice));
...
function normalizeProvider(
  ...
  value: unknown,
): AlienProviderIndexProvider | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
export function normalizeAlienProviderIndex(value: unknown): AlienProviderIndex | undefined {
  if (!isRecord(value) || value.version !== ALIEN_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  if (!isRecord(value.providers)) {
    return undefined;
  }
  const providers: Record<string, AlienProviderIndexProvider> = {};
  ...
  return {
    version: ALIEN_PROVIDER_INDEX_VERSION,
