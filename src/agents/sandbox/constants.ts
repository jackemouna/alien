...
export const DEFAULT_SANDBOX_IMAGE = "alien-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "alien-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "alien-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "alien-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "alien-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "alien-sandbox-browser";
