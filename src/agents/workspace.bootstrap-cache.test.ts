...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    ...
    workspaceDir = await makeTempWorkspace("alien-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("alien-cache-test1-");
    const workspace2 = await makeTempWorkspace("alien-cache-test2-");
