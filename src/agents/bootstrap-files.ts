...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "alien:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: AlienConfig): AgentContextInjection {
