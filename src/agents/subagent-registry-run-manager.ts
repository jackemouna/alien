...
const RECOVERABLE_WAIT_RETRY_DELAY_MS = process.env.ALIEN_TEST_FAST === "1" ? 25 : 5_000;
...
export function createSubagentRunManager(params: {
  ...
  resolveSubagentWaitTimeoutMs(cfg: AlienConfig, runTimeoutSeconds?: number): number;
