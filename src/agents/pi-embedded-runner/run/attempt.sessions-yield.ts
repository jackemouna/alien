...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "alien.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "alien.sessions_yield";
const SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS = process.env.ALIEN_TEST_FAST === "1" ? 250 : 2_000;
