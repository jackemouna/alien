...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("alien.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: AlienConfig): number {
