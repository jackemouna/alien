...
export function isConfigPathTruthy(config: AlienConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["alien-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: AlienConfig): string[] | undefined {
