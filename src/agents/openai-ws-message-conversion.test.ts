    ...
    const [tool] = convertTools([
      {
        name: "image_generate",
        description:
          'Generate images. For transparent OpenAI backgrounds, use outputFormat="png" or "webp" and openai.background="transparent"; Alien routes the default OpenAI image model to gpt-image-1.5 for that mode.',
        parameters: {
          type: "object",
          properties: {
            model: {
            ...
            openai: {
              ...
              properties: {
                background: {
                  ...
                  description:
                    "For transparent output use outputFormat png or webp; Alien routes the default OpenAI image model to gpt-image-1.5 for this mode.",
                },
              },
            },
          },
