...
function hasExplicitMusicGenerationModelConfig(cfg?: AlienConfig): boolean {
...
export function createMusicGenerateTool(options?: {
  ...
  return {
    ...
    description:
      "Generate music using configured providers. Generated tracks are saved under Alien-managed media storage and delivered automatically as attachments.",
