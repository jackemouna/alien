...
export function coerceImageModelConfig(cfg?: AlienConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: AlienConfig; ref: string }): string[] {
