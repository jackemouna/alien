...
// Keep the schema local to avoid a circular import through acp-spawn/alien-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: AlienConfig }) {
