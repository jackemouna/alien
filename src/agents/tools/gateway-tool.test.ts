...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: alien doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: alien doctor --non-interactive");
