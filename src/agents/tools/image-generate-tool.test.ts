...
describe("createImageGenerateTool", () => {
  ...
  it("includes MEDIA paths in content text so follow-up replies use the real saved file", async () => {
    ...
    vi.spyOn(mediaStore, "saveMediaBuffer").mockResolvedValueOnce({
      path: "/home/alien/.alien/media/tool-image-generation/kodo_sawaki_zazen---3337a0ed-898a-4572-8950-0d288719f4f8.jpg",
    ...
    expect(text).toContain(
      "MEDIA:/home/alien/.alien/media/tool-image-generation/kodo_sawaki_zazen---3337a0ed-898a-4572-8950-0d288719f4f8.jpg",
    );
    expect(result.details).toMatchObject({
      media: {
        mediaUrls: [
          "/home/alien/.alien/media/tool-image-generation/kodo_sawaki_zazen---3337a0ed-898a-4572-8950-0d288719f4f8.jpg",
        ],
      },
    });
  });
