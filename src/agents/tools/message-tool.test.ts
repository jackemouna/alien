...
type CreateAlienTools = typeof import("../alien-tools.js").createAlienTools;
...
let createAlienTools: CreateAlienTools;
...
beforeAll(async () => {
  ...
  ({ createAlienTools } = await import("../alien-tools.js"));
});
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createAlienTools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
