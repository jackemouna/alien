...
describe("isSilentOverflowProneModel", () => {
  ...
  // alien#75799 reporter's setup: an OpenAI-compatible in-house gateway
  ...
  // Alien's preemptive compaction continues to handle real overflow.
...
describe("applyPiAutoCompactionGuard", () => {
  // Direct repro of alien#75799: pi-ai's silent-overflow detection misfires
  ...
  // state.messages intact; Alien's preemptive compaction continues to
