...
async function resolveContext(config: AlienConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AlienConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
