...
type CreateAlienToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateAlienToolsOpts) {
...
vi.mock("../config/sessions.js", () => ({
  ...
  resolveStorePath: () => "/tmp/alien-sessions-spawn-test-store.json",
