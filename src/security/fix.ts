...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AlienConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AlienConfig; env: NodeJS.ProcessEnv }): {
  cfg: AlienConfig;
  changes: string[];
} {
