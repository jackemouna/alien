...
const CHANNEL_RUNTIME_SDK_SURFACE = ["alien/plugin-sdk/channel", "runtime"].join("-");
...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    warningStarts: "2026-04-24",
    removeAfter: "2026-07-24",
    replacement: "focused `alien/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/plugin-sdk", "alien/plugin-sdk/compat"],
    diagnostics: ["ALIEN_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      "alien/plugin-sdk/discord component message helpers",
      "alien/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    replacement:
      "`alien/plugin-sdk/bundled-channel-config-schema` for maintained bundled plugins; plugin-local schemas for third-party plugins",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/plugin-sdk/channel-config-schema-legacy"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-28",
    replacement:
      "focused `alien/plugin-sdk/*` test subpaths such as `plugin-test-runtime`, `channel-test-helpers`, `test-env`, and `test-fixtures`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/plugin-sdk/testing"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "alien/plugin-sdk/channel-route channelRouteIdentityKey",
      "alien/plugin-sdk/channel-route channelRouteKey",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
  ...
  },
  {
    ...
    surfaces: ["alien.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["alien.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`alien/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
    surfaces: ["alien/plugin-sdk/agent-harness", "alien/plugin-sdk/agent-harness-runtime"],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-25",
    removeAfter: "2026-07-25",
    replacement: "`alien plugins registry --refresh` and `alien doctor --fix`",
    docsPath: "/cli/plugins#registry",
    surfaces: ["ALIEN_DISABLE_PERSISTED_PLUGIN_REGISTRY", "plugin registry reads"],
  ...
  },
  {
    ...
    docsPath: "/cli/plugins#registry",
    surfaces: [
      "ALIEN_DISABLE_PLUGIN_REGISTRY_MIGRATION",
      "ALIEN_FORCE_PLUGIN_REGISTRY_MIGRATION",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`alien.channel.exposure` metadata",
    docsPath: "/plugins/sdk-setup",
    surfaces: ["alien.channel.showConfigured", "alien.channel.showInSetup"],
  ...
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "focused channel SDK subpaths, especially `alien/plugin-sdk/channel-runtime-context`",
    docsPath: "/plugins/sdk-migration",
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`alien/plugin-sdk/command-status`",
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "alien/plugin-sdk/command-auth buildCommandsMessage",
      "alien/plugin-sdk/command-auth buildCommandsMessagePaginated",
      "alien/plugin-sdk/command-auth buildHelpMessage",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`AlienConfig`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/plugin-sdk `ClawdbotConfig` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    code: "alien-schema-type-alias",
    status: "deprecated",
    owner: "sdk",
    introduced: "2026-04-26",
    deprecated: "2026-04-26",
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "`AlienConfig` from `alien/plugin-sdk/config-schema`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/plugin-sdk `AlienSchemaType` type export"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-index.test.ts"],
  },
  {
    ...
    removeAfter: "2026-07-26",
    replacement:
      "injected `api.runtime.*` helpers or focused `alien/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/extension-api"],
    diagnostics: ["ALIEN_EXTENSION_API_DEPRECATED"],
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "alien/plugin-sdk/channel-actions createMessageToolButtonsSchema",
      "alien/plugin-sdk/channel-actions createMessageToolCardSchema",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-migration",
    surfaces: [
      "alien/plugin-sdk/channel-inbound resolveMentionGating",
      "alien/plugin-sdk/channel-inbound resolveMentionGatingWithBypass",
      "alien/plugin-sdk/channel-mention-gating resolveMentionGating",
      "alien/plugin-sdk/channel-mention-gating resolveMentionGatingWithBypass",
    ],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
    ...
    docsPath: "/plugins/sdk-provider-plugins",
    surfaces: ["alien/plugin-sdk/provider-web-search createPluginBackedWebSearchProvider"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: ["src/plugins/contracts/plugin-sdk-subpaths.test.ts"],
  },
  {
  ...
  },
  {
    ...
    warningStarts: "2026-04-26",
    removeAfter: "2026-07-26",
    replacement: "focused `alien/plugin-sdk/*` test subpaths",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["alien/plugin-sdk/test-utils"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
      "src/plugins/contracts/plugin-sdk-subpaths.test.ts",
