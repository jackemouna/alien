...
} & PluginActivationConfigSourceLike<AlienConfig>;
...
const hasExplicitMemorySlot = (plugins?: AlienConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: AlienConfig["plugins"]) =>
  Boolean(
    plugins?.entries &&
    Object.prototype.hasOwnProperty.call(plugins.entries, defaultSlotIdForKey("memory")),
  );

export const hasExplicitPluginConfig = (plugins?: AlienConfig["plugins"]) =>
