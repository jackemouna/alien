...
function listPotentialEnabledChannelIds(config: AlienConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: AlienConfig): Set<string> {
