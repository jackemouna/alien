...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.alien.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.alien.js").AlienConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.alien.js").AlienConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.alien.js").AlienConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.alien.js").AlienConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.alien.js").AlienConfig,
