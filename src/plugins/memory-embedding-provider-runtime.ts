...
function readConfiguredProviderApiId(providerId: string, cfg?: AlienConfig): string | undefined {
...
function resolveMemoryEmbeddingProviderLookupIds(id: string, cfg?: AlienConfig): string[] {
  const ids = [id];
