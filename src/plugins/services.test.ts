...
import type { AlienPluginService, AlienPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: AlienPluginServiceContext) {
...
function expectServiceContexts(
  contexts: AlienPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: AlienPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: AlienPluginServiceContext[] = [];
    ...
    const officialInstallContexts: AlienPluginServiceContext[] = [];
    ...
    const untrustedContexts: AlienPluginServiceContext[] = [];
    ...
    const spoofedContexts: AlienPluginServiceContext[] = [];
