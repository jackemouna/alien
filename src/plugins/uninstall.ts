...
import { relinkAlienPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: AlienConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: AlienConfig = {
    ...
    channels: channels as AlienConfig["channels"],
  };
