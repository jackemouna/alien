...
import type { AlienPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: AlienPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): AlienPluginConfigSchema {
  return {
