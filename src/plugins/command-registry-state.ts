...
import type { AlienPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = AlienPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("alien.pluginCommandsState");
