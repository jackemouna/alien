...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Alien from plugin manifests, install records, and config policy. Use `alien plugins registry --refresh`, `alien plugins install/update/uninstall`, or `alien plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored alien.install metadata. This describes catalog/package
