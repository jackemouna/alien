...
describe("plugin loader CLI metadata", () => {
  ...
  register(api) {
    ...
    const registry = await loadAlienPluginCliRegistry({
      env: { ...process.env, ALIEN_STATE_DIR: stateDir },
      logger: {
        info: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@alien/cli-metadata-channel",
          alien: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    process.env.ALIEN_BUNDLED_PLUGINS_DIR = bundledRoot;

    fs.writeFileSync(
      path.join(pluginDir, "package.json"),
      JSON.stringify(
        {
          name: "@alien/bundled-skip-channel",
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@alien/bundled-cli-channel",
          alien: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@alien/bundled-skip-provider",
          alien: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@alien/full-cli-metadata-channel",
          alien: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during discovery plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@alien/discovery-cli-metadata-channel",
          alien: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  require("node:fs").writeFileSync(${JSON.stringify(runtimeMarker)}, "loaded", "utf-8");
    ...
    entry.register({
      ...
      runtime: {} as AlienPluginApi["runtime"],
