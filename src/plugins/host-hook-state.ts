...
function loadPluginHostHookSessionEntry(params: { cfg: AlienConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: AlienConfig, pluginId: string): boolean {
