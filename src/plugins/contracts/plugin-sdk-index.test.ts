...
import type { ClawdbotConfig, AlienConfig, AlienSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<AlienConfig>();
    expectTypeOf<AlienSchemaType>().toEqualTypeOf<AlienConfig>();
  });
