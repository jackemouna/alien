...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "alien/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "alien/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "alien/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiAlienConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "alien/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "alien/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "alien/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "alien/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "alien/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "alien/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "alien/plugin-sdk/channel-status";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "alien/plugin-sdk/runtime-group-policy";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "alien/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "alien/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]: [
    ...
    'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "alien/plugin-sdk/allow-from";',
    'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "alien/plugin-sdk/channel-contract";',
    ...
    'export { createChannelPairingController } from "alien/plugin-sdk/channel-pairing";',
    'export { evaluateSenderGroupAccessForPolicy, readStoreAllowFromForDmPolicy, resolveDmGroupAccessWithLists, resolveEffectiveAllowFromLists, resolveSenderScopedGroupPolicy, resolveToolsBySender } from "alien/plugin-sdk/channel-policy";',
    'export { createChannelMessageReplyPipeline } from "alien/plugin-sdk/channel-message";',
    'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "alien/plugin-sdk/channel-status";',
    'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "alien/plugin-sdk/channel-targets";',
    'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, AlienConfig } from "alien/plugin-sdk/config-types";',
    'export { isDangerousNameMatchingEnabled } from "alien/plugin-sdk/dangerous-name-runtime";',
    ...
    'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "alien/plugin-sdk/media-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "alien/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "alien/plugin-sdk/channel-contract";',
    'export type { AlienConfig } from "alien/plugin-sdk/config-types";',
  ...
  [bundledPluginFile({
    ...
    'export { createChannelPairingController } from "alien/plugin-sdk/channel-pairing";',
    'export { readStoreAllowFromForDmPolicy, resolveDmGroupAccessWithCommandGate } from "alien/plugin-sdk/channel-policy";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, AlienConfig } from "alien/plugin-sdk/config-types";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "alien/plugin-sdk/runtime-group-policy";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { AlienPluginService, AlienPluginServiceContext, PluginLogger } from "alien/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "alien/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "alien/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "alien/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "alien/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "alien/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "alien/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "alien/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "alien/plugin-sdk/channel-core";',
      'export type { AlienConfig } from "alien/plugin-sdk/config-types";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeAlienConfig["channels"]>["telegram"] >;',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "alien/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "alien/plugin-sdk/channel-core";',
  ...
  [bundledPluginFile({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "alien/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "alien/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"alien/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'alien/plugin-sdk/${pluginId}'`);
