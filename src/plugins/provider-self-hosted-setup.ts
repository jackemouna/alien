...
export function applyProviderDefaultModel(cfg: AlienConfig, modelRef: string): AlienConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: AlienConfig; modelId: string; modelRef: string; profileId: string } {
