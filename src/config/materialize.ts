...
import type { AlienConfig, ResolvedSourceConfig, RuntimeConfig } from "./types.js";
...
export function asResolvedSourceConfig(config: AlienConfig): ResolvedSourceConfig {
  return config as ResolvedSourceConfig;
}

export function asRuntimeConfig(config: AlienConfig): RuntimeConfig {
