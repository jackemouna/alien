...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.ALIEN_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.ALIEN_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.ALIEN_WATCH_COMMAND),
