...
import type { ConfigFileSnapshot } from "./types.alien.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/alien.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/alien/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/alien/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/alien/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/alien/nickserv-password.txt");
