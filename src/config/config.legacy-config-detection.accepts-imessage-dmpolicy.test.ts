...
function expectAlienSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = AlienSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectAlienSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = AlienSchema.safeParse(config);
