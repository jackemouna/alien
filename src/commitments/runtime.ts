...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: AlienConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: AlienConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: AlienConfig }>,
