...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("alien");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "alien");
