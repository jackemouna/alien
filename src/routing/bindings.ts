...
export function listBindings(cfg: AlienConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: AlienConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AlienConfig) {
