...
type AlienReferencePaths = Awaited<ReturnType<typeof resolveAlienReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveAlienReferencePaths?: typeof resolveAlienReferencePaths;
};
...
function buildAgentSummaries(cfg: AlienConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): AlienReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveAlienReferencePaths ?? resolveAlienReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: ALIEN_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: ALIEN_SOURCE_URL,
    },
  };
}
