...
type ChannelConfigAccessorParams<Config extends AlienConfig = AlienConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends AlienConfig = AlienConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends AlienConfig = AlienConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: AlienConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends AlienConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends AlienConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends AlienConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
