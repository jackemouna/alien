...
export function resolveSessionToolsVisibility(cfg: AlienConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: AlienConfig): "spawned" | "all" {
  return cfg.agents?.defaults?.sandbox?.sessionToolsVisibility ?? "spawned";
}

export function createAgentToAgentPolicy(cfg: AlienConfig): AgentToAgentPolicy {
