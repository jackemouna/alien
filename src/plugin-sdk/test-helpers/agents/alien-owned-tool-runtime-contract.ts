...
export function installAlienOwnedToolHooks(params?: {
 ...
 * Pair with `installAlienOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetAlienOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
