...
type LoginOpenAICodexOAuth =
  (typeof import("alien/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("alien/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type EnsureAuthProfileStore =
  typeof import("alien/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("alien/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("alien/plugin-sdk/provider-auth-login", async () => {
      const actual = await vi.importActual<
        typeof import("alien/plugin-sdk/provider-auth-login")
      >("alien/plugin-sdk/provider-auth-login");
      return {
        ...actual,
    ...
    vi.doMock("alien/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("alien/plugin-sdk/provider-auth")>(
        "alien/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
