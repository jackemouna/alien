...
import type { ModelDefinitionConfig, AlienConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: AlienConfig) => AlienConfig;
  applyLitellmProviderConfig: (cfg: AlienConfig) => AlienConfig;
