...
const ALIEN_SOURCE_EXTENSIONS_ROOT = path.resolve(ALIEN_PACKAGE_ROOT, "extensions");
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  const bundledLocation = resolveBundledFacadeModuleLocation({
    ...
    packageRoot: ALIEN_PACKAGE_ROOT,
    bundledPluginsDir,
  });
  if (bundledLocation) {
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: ALIEN_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
