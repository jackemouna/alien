...
import type { AlienPluginApi } from "../plugins/types.js";
...
export type { AlienPluginToolContext, AlienPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: AlienConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
