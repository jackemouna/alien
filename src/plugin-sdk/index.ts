...
/** @deprecated Use AlienConfig instead */
export type { AlienConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use AlienConfig instead */
export type { AlienConfig as AlienSchemaType } from "../config/config.js";
export type {
