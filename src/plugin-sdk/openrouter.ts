...
import type { ModelProviderConfig, AlienConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: AlienConfig) => AlienConfig;
  applyOpenrouterProviderConfig: (cfg: AlienConfig) => AlienConfig;
