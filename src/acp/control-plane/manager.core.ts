...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: AlienConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: AlienConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: AlienConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: AlienConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: AlienConfig }): Promise<void> {
