...
export function isAcpEnabledByPolicy(cfg: AlienConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AlienConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AlienConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AlienConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AlienConfig): AcpRuntimeError | null {
...
export function resolveAcpExplicitTurnPolicyError(cfg: AlienConfig): AcpRuntimeError | null {
  if (isAcpEnabledByPolicy(cfg)) {
    return null;
  }
...
export function isAcpAgentAllowedByPolicy(cfg: AlienConfig, agentId: string): boolean {
