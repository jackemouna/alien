...
export function hasAmbiguousGatewayAuthModeConfig(cfg: AlienConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: AlienConfig): void {
