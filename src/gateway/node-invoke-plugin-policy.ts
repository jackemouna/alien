...
import type {
  ...
  AlienPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): AlienPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: AlienPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
