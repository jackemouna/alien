 ...
 *
 * @see https://github.com/alien/alien/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an AlienConfig.
 */
export function timestampOptsFromConfig(cfg: AlienConfig): TimestampInjectionOptions {
  return {
