...
import type { AlienConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
...
function buildTalkTtsConfig(
  ...
  | { cfg: AlienConfig; provider: string; providerConfig: TalkProviderConfig }
...
function buildTalkCatalog(config: AlienConfig) {
