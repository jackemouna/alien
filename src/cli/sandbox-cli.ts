...
const SANDBOX_EXAMPLES = {
  main: [
    ["alien sandbox list", "List all sandbox containers."],
    ["alien sandbox list --browser", "List only browser containers."],
    ["alien sandbox recreate --all", "Recreate all containers."],
    ["alien sandbox recreate --session main", "Recreate a specific session."],
    ["alien sandbox recreate --agent mybot", "Recreate agent containers."],
    ["alien sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["alien sandbox list", "List all sandbox containers."],
    ["alien sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["alien sandbox recreate --all", "Recreate all containers."],
    ["alien sandbox recreate --session main", "Recreate a specific session."],
    ["alien sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["alien sandbox recreate --browser --all", "Recreate only browser containers."],
    ["alien sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["alien sandbox explain", "Show effective sandbox config."],
    ["alien sandbox explain --session agent:main:main", "Explain a specific session."],
    ["alien sandbox explain --agent work", "Explain an agent sandbox."],
    ["alien sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.alien.ai/cli/sandbox")}\n`,
    )
    .action(() => {
