...
export function registerSetupCommand(program: Command) {
  program
    .command("setup")
    .description("Initialize the active Alien config and agent workspace")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/setup", "docs.alien.ai/cli/setup")}\n`,
    )
    .option(
      "--workspace <dir>",
      "Agent workspace directory (default: ~/.alien/workspace; stored as agents.defaults.workspace)",
    )
