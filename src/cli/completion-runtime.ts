...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "ALIEN_COMPLETION_SKIP_PLUGIN_COMMANDS";
...
function isCompletionProfileHeader(line: string): boolean {
  return line.trim() === "# Alien Completion";
}
 ...
 * Returns true if profile has `source <(alien completion ...)` instead of cached file.
 */
...
export async function installCompletion(shell: string, yes: boolean, binName = "alien") {
  const home = process.env.HOME || os.homedir();
  let profilePath = "";
  let sourceLine = "";
