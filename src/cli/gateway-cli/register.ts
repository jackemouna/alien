      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["alien gateway run", "Run the gateway in the foreground."],
            ["alien gateway status", "Show service status plus connectivity/capability."],
            ["alien gateway discover", "Find local and wide-area gateway beacons."],
            ["alien gateway stability", "Show recent stability diagnostics."],
            ["alien gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.alien.ai/cli/gateway")}\n`,
      ),
  );
