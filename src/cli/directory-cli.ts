    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["alien directory self --channel slack", "Show the connected account identity."],
          [
            'alien directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["alien directory groups list --channel discord", "List available groups/channels."],
          [
            "alien directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.alien.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
