...
function makeContext(sourceConfig: AlienConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: AlienConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: AlienConfig): void {
