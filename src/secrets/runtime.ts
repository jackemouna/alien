...
function hasConfiguredPluginEntries(config: AlienConfig): boolean {
...
function hasConfiguredChannelEntries(config: AlienConfig): boolean {
...
function hasRuntimeWebToolConfigSurface(config: AlienConfig): boolean {
