...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://alien.local")).toBe("https://alien.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://alien.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: alien security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://alien.local" },
      ...
      { Item: "Security", Value: "Run: alien security audit --deep" },
