...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: AlienConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: AlienConfig, deps?: BrowserDoctorDeps) {
  try {
