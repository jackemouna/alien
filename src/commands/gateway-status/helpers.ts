...
import type { AlienConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: AlienConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
export function buildNetworkHints(cfg: AlienConfig) {
