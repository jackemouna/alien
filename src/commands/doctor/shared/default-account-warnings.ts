...
export function collectMissingDefaultAccountBindingWarnings(cfg: AlienConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: AlienConfig): string[] {
  const warnings: string[] = [];
