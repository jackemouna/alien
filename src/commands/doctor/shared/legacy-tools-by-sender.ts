...
export function scanLegacyToolsBySenderKeys(cfg: AlienConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AlienConfig): {
  config: AlienConfig;
  changes: string[];
} {
