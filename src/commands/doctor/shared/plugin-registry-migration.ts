...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "ALIEN_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "ALIEN_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<AlienConfig> | AlienConfig;
  };
...
function listConfiguredChannelIds(config: AlienConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: AlienConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as AlienConfig;
