...
function resolveConfiguredCommandOwners(cfg: AlienConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: AlienConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: AlienConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("alien config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
