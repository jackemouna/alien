...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.alien.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("alien hooks list")}`,
      `  ${formatCliCommand("alien hooks enable <name>")}`,
      `  ${formatCliCommand("alien hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
