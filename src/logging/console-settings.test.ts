...
let originalAlienTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalAlienTestConsole = process.env.ALIEN_TEST_CONSOLE;
  process.env.ALIEN_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalAlienTestConsole === undefined) {
    delete process.env.ALIEN_TEST_CONSOLE;
  } else {
    process.env.ALIEN_TEST_CONSOLE = originalAlienTestConsole;
  }
