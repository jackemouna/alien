...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __alienDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore.__alienDiagnosticStabilityState ??= createState();
  return globalStore.__alienDiagnosticStabilityState;
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore.__alienDiagnosticStabilityState = next;
}
