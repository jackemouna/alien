...
const SUPPORT_EXPORT_PREFIX = "alien-diagnostics-";
...
function readStabilityBundle(
  ...
  if (target === false) {
    return { status: "missing", dir: "$ALIEN_STATE_DIR/logs/stability" };
  }
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/alien-sanitized.jsonl`: sanitized log summaries and metadata",
