...
const logPathTracker = createSuiteLogPathTracker("alien-subsystem-log-");
...
describe("createSubsystemLogger().isEnabled", () => {
  ...
  it("keeps long-lived subsystem loggers on the current-day rolling file", () => {
    ...
    const firstDay = path.join(logDir, "alien-2026-01-01.log");
    const secondDay = path.join(logDir, "alien-2026-01-02.log");
    vi.useFakeTimers();
