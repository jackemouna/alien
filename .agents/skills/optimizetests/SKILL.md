---
name: optimizetests
description: Optimize Alien slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real Alien test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `ALIEN_VITEST_IMPORT_DURATIONS=1 ALIEN_VITEST_PRINT_IMPORT_BREAKDOWN=1`
