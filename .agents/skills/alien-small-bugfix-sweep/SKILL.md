---
name: alien-small-bugfix-sweep
description: Fix only small, high-certainty Alien bugs from a pasted issue/PR list after deep code review.
---

# Alien Small Bugfix Sweep

Batch workflow for pasted Alien issue/PR refs.
...
Use `$gitcrawl` first, `$alien-pr-maintainer` for live GitHub hygiene, `$github-deep-review` posture for source tracing, and `$alien-testing` for proof.
