---
name: alien-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Alien GitHub Secret Scanning alerts in issues or PRs.
---

# Alien Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/alien/alien/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/alien-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/alien/alien/issues/63101#issuecomment-xxx",
