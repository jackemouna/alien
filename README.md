# 👾 Alien — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/alien-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/alien-logo-text.svg" alt="Alien" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/alien/alien/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/alien/alien/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/alien/alien/releases"><img src="https://img.shields.io/github/v/release/alien/alien?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Alien** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://alien.ai) · [Docs](https://docs.alien.ai) · [Vision](VISION.md) · [DeepWiki](https://deepwiki.com/alien/alien) · [Getting Started](https://docs.alien.ai/start/getting-started) · [Updating](https://docs.alien.ai/install/updating) · [Showcase](https://docs.alien.ai/start/showcase) · [FAQ](https://docs.alien.ai/help/faq) · [Onboarding](https://docs.alien.ai/start/wizard) · [Nix](https://github.com/alien/nix-alien) · [Docker](https://docs.alien.ai/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.alien.ai/start/getting-started)

Preferred setup: run `alien onboard` in your terminal.
Alien Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/alien/alien/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.alien.ai/start/onboarding).
...
```bash
npm install -g alien@latest
# or: pnpm add -g alien@latest

alien onboard --install-daemon
```

Alien Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.14+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.alien.ai/start/getting-started)

```bash
alien onboard --install-daemon

alien gateway --port 18789 --verbose

# Send a message
alien message send --target +1234567890 --message "Hello from Alien"
...
alien agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.alien.ai/install/updating) (and run `alien doctor`).

Models config + CLI: [Models](https://docs.alien.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.alien.ai/concepts/model-failover).

## Security defaults (DM access)

Alien connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.alien.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `alien pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `alien doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.alien.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.alien.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.alien.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.alien.ai/nodes/voicewake) + [Talk Mode](https://docs.alien.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.alien.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.alien.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.alien.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.alien.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.alien.ai/nodes).
- **[Onboarding](https://docs.alien.ai/start/wizard) + [skills](https://docs.alien.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.alien.ai/gateway/security), [Sandboxing](https://docs.alien.ai/gateway/sandboxing), and [Configuration](https://docs.alien.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.alien.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.alien.ai/start/getting-started), [Onboarding](https://docs.alien.ai/start/wizard), [Updating](https://docs.alien.ai/install/updating)
- Channel setup: [Channels index](https://docs.alien.ai/channels), [WhatsApp](https://docs.alien.ai/channels/whatsapp), [Telegram](https://docs.alien.ai/channels/telegram), [Discord](https://docs.alien.ai/channels/discord), [Slack](https://docs.alien.ai/channels/slack)
- Apps + nodes: [macOS](https://docs.alien.ai/platforms/macos), [iOS](https://docs.alien.ai/platforms/ios), [Android](https://docs.alien.ai/platforms/android), [Nodes](https://docs.alien.ai/nodes)
- Config + security: [Configuration](https://docs.alien.ai/gateway/configuration), [Security](https://docs.alien.ai/gateway/security), [Sandboxing](https://docs.alien.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.alien.ai/gateway), [Remote access](https://docs.alien.ai/gateway/remote), [Tailscale](https://docs.alien.ai/gateway/tailscale), [Web surfaces](https://docs.alien.ai/web)
- Tools + automation: [Tools](https://docs.alien.ai/tools), [Skills](https://docs.alien.ai/tools/skills), [Cron jobs](https://docs.alien.ai/automation/cron-jobs), [Webhooks](https://docs.alien.ai/automation/webhook), [Gmail Pub/Sub](https://docs.alien.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.alien.ai/concepts/architecture), [Agent](https://docs.alien.ai/concepts/agent), [Session model](https://docs.alien.ai/concepts/session), [Gateway protocol](https://docs.alien.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.alien.ai/channels/troubleshooting), [Logging](https://docs.alien.ai/logging), [Docs home](https://docs.alien.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.alien.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `alien nodes …`.

Runbook: [iOS connect](https://docs.alien.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`alien devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.alien.ai/platforms/android).
...
# First run only (or after resetting local Alien config/workspace)
pnpm alien setup
...
`pnpm alien setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm alien onboard --install-daemon`.

Note: `pnpm alien ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `alien` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `alien update --channel stable|beta|dev`.
Details: [Development channels](https://docs.alien.ai/install/development-channels).
...
- Workspace root: `~/.alien/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.alien/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.alien/alien.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.alien.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=alien/alien&type=date&legend=top-left)](https://www.star-history.com/#alien/alien&type=date&legend=top-left)

## Molty

Alien was built for **Molty**, a space lobster AI assistant. 👾
by Peter Steinberger and the community.

- [alien.ai](https://alien.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@alien](https://x.com/alien)
