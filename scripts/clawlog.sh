...
show_usage() {
    cat << EOF
clawlog - Alien Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Alien logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Alien logs flow through the macOS unified log (subsystem: ai.alien).
