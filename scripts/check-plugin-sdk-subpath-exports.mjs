...
async function main() {
  ...
  if (violations.length === 0) {
    console.log("OK: all referenced alien/plugin-sdk/<subpath> imports are exported.");
    return;
  }

  console.error(
    "Rule: every referenced alien/plugin-sdk/<subpath> must exist in the public package exports.",
  );
