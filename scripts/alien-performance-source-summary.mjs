...
function printHelp() {
  console.log(`Usage: node scripts/alien-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes Alien-native performance probe artifacts for CI reports.`);
}
