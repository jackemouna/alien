...
# Output:
# - dist/Alien.app
# - dist/Alien-<version>.zip
# - dist/Alien-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.alien.mac}"
...
ZIP="$ROOT_DIR/dist/Alien-$VERSION.zip"
DMG="$ROOT_DIR/dist/Alien-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Alien-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Alien-$VERSION.dSYM.zip"
