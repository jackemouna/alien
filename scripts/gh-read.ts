...
const APP_ID_ENV = "ALIEN_GH_READ_APP_ID";
const KEY_FILE_ENV = "ALIEN_GH_READ_PRIVATE_KEY_FILE";
const INSTALLATION_ID_ENV = "ALIEN_GH_READ_INSTALLATION_ID";
const PERMISSIONS_ENV = "ALIEN_GH_READ_PERMISSIONS";
...
async function main() {
  if (process.argv.length <= 2) {
    fail(
      "usage: scripts/gh-read <gh args...>\nset ALIEN_GH_READ_APP_ID and ALIEN_GH_READ_PRIVATE_KEY_FILE first",
    );
  }
