...
- ALIEN_IOS_VERSION = exact canonical iOS version
- ALIEN_MARKETING_VERSION = short iOS/App Store version
- ALIEN_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ALIEN_IOS_VERSION = ${IOS_VERSION}
ALIEN_MARKETING_VERSION = ${MARKETING_VERSION}
ALIEN_BUILD_VERSION = ${BUILD_NUMBER}
EOF
