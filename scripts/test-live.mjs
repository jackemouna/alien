...
const env = {
  ...process.env,
  ALIEN_LIVE_TEST: process.env.ALIEN_LIVE_TEST || "1",
  ALIEN_LIVE_TEST_QUIET: quietOverride ?? process.env.ALIEN_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.ALIEN_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
