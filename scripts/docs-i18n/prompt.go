...
- Keep product names in English: Alien, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Alien Gateway, use “Gateway 网关”.
