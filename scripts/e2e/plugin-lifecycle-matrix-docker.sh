...
IMAGE_NAME="$(docker_e2e_resolve_image "alien-plugin-lifecycle-matrix-e2e" ALIEN_PLUGIN_LIFECYCLE_MATRIX_E2E_IMAGE)"
SKIP_BUILD="${ALIEN_PLUGIN_LIFECYCLE_MATRIX_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz plugin-lifecycle-matrix "${ALIEN_CURRENT_PACKAGE_TGZ:-}")"
...
ALIEN_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 plugin-lifecycle-matrix empty)"
