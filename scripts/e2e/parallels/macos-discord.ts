...
${this.input.guestNode} ${this.input.guestAlienEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestAlienEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestAlienEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestAlienEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestAlienEntry} doctor --fix --yes --non-interactive
${this.input.guestNode} ${this.input.guestAlienEntry} gateway restart
${this.input.guestNode} ${this.input.guestAlienEntry} channels status --probe --json`);
  }
