...
const pluginRecordSnapshot = () => {
  const config = readJson(alienPath("alien.json"));
...
function seedInstallState() {
  writeJson(alienPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.ALIEN_CONFIG_PATH, { plugins: {} });
  writeJson(alienPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Alien plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Alien will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  for (const expected of [
    ...
    `Run alien plugins inspect ${pluginId} --runtime --json for details.`,
  ]) {
