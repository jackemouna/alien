...
const pageSize = Number.parseInt(process.env.ALIEN_PROC_PAGE_SIZE || "4096", 10);
const clockTicks = Number.parseInt(process.env.ALIEN_PROC_CLK_TCK || "100", 10);
const pollMs = Number.parseInt(process.env.ALIEN_PLUGIN_LIFECYCLE_METRIC_POLL_MS || "100", 10);
