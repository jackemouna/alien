...
IMAGE_NAME="$(docker_e2e_resolve_image "alien-commitments-safety-e2e" ALIEN_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="alien-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t alien-commitments-safety-log.XXXXXX)"
