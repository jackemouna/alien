...
export function resolveTavilySearchConfig(cfg?: AlienConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: AlienConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: AlienConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
