...
import { asFiniteNumber, asObject, trimToUndefined } from "alien/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: AlienConfig | undefined): string | undefined {
