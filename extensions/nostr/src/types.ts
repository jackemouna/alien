...
import { normalizeSecretInputString, type SecretInput } from "alien/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: AlienConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: AlienConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: AlienConfig): string {
