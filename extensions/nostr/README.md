...
Nostr DM channel plugin for Alien using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Alien. It enables your bot to:
...
# Configure alien to use local relay
