...
function resolveAlienVersion(): string {
  try {
 ...
 * and appends the Alien version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Alien/<alien-version>"
 * Example: "teams.ts[apps]/2.0.5 Alien/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Alien/${resolveAlienVersion()}`;
  return cachedUserAgent;
}
