...
import { createAsyncLock } from "alien/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "alien/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "alien/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "alien/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- alien:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- alien:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "alien:dreaming:backfill-entry";
