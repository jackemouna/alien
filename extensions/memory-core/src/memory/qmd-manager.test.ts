...
const MEMORY_EMBEDDING_PROVIDERS_KEY = Symbol.for("alien.memoryEmbeddingProviders");
const MCPORTER_STATE_KEY = Symbol.for("alien.mcporterState");
const QMD_EMBED_QUEUE_KEY = Symbol.for("alien.qmdEmbedQueueTail");
...
vi.mock("alien/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("alien/plugin-sdk/memory-core-host-engine-foundation")
  >("alien/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
vi.mock("alien/plugin-sdk/file-lock", async () => {
  const actual = await vi.importActual<typeof import("alien/plugin-sdk/file-lock")>(
    "alien/plugin-sdk/file-lock",
  );
  return {
    ...actual,
