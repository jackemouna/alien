...
import { extractKeywords } from "alien/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("alien.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: AlienConfig;
