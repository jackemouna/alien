...
import { resolveUserPath } from "alien/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "alien/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? `2) Install ${NODE_LLAMA_CPP_RUNTIME_PACKAGE} next to the Alien package or source checkout`
      : null,
