...
class SessionDeltaHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as AlienConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/alien-test-workspace";
...
describe("session archive delta bypass", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "alien-archive-delta-"));
  });
