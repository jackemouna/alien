...
import { resolveEnvApiKey } from "alien/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: AlienConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: AlienConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: AlienConfig): string {
