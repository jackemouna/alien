...
import { isVoiceCompatibleAudio } from "alien/plugin-sdk/media-runtime";
...
import type {
  ...
  SpeechVoiceOption,
} from "alien/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "alien/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,
