...
function mergeSignalAccountConfig(cfg: AlienConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AlienConfig): ResolvedSignalAccount[] {
