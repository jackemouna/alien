...
vi.mock("alien/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("alien/plugin-sdk/hook-runtime")>(
    "alien/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
