...
function resolveGoogleChatAccountImpl(params: { cfg: AlienConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: AlienConfig) => {
...
function createGoogleChatCfg(): AlienConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
