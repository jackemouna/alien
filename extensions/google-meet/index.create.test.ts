...
describe("google-meet create flow", () => {
  ...
  it("reports structured manual action when browser creation needs Google login", async () => {
              ...
              payload: {
                result: {
                  ...
                  result: {
                    ...
                    manualAction:
                      "Sign in to Google in the Alien browser profile, then retry meeting creation.",
    ...
    expect(respond.mock.calls[0]?.[1]).toMatchObject({
      source: "browser",
      error:
        "google-login-required: Sign in to Google in the Alien browser profile, then retry meeting creation.",
              ...
              payload: {
                result: {
                  ...
                  result: {
                    ...
                    manualAction:
                      "Allow microphone/camera permissions for Meet in the Alien browser profile, then retry meeting creation.",
