...
import { buildCopilotDynamicHeaders } from "alien/plugin-sdk/provider-stream-shared";
...
const ENV_GITHUB_TOKEN =
  process.env.ALIEN_LIVE_GITHUB_COPILOT_TOKEN ??
  process.env.COPILOT_GITHUB_TOKEN ??
  process.env.GH_TOKEN ??
  process.env.GITHUB_TOKEN ??
  "";
const LIVE_MODEL_ID = process.env.ALIEN_LIVE_GITHUB_COPILOT_MODEL?.trim() || "gpt-5.4";
