...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: AlienConfig, accountId?: string) => {
  ...
  getCurrent: (cfg: AlienConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: AlienConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure Alien has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: AlienConfig; accountId?: string }) =>
