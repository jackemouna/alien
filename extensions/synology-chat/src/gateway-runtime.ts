import { DEFAULT_ACCOUNT_ID, type AlienConfig } from "alien/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "alien/plugin-sdk/webhook-ingress";
