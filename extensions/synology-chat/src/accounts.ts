...
import { resolveDangerousNameMatchingEnabled } from "alien/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full Alien config object. */
function getChannelConfig(cfg: AlienConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: AlienConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.ALIEN_BOT_NAME ?? "Alien";
