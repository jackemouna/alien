...
function resolveQianfanPreset(cfg: AlienConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: AlienConfig): AlienConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: AlienConfig): AlienConfig {
