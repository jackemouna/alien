import { createClaimableDedupe } from "alien/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: AlienConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<AlienConfig["channels"]>["mattermost"]>;
