import { resolveApiKeyForProvider } from "alien/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "alien/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
} from "alien/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "alien/plugin-sdk/agent-runtime";
import type { AlienConfig } from "alien/plugin-sdk/config-types";
import { resolveAutoImageModel } from "alien/plugin-sdk/media-runtime";
import {
