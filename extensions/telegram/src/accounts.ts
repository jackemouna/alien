...
import {
  ...
  type AlienConfig,
} from "alien/plugin-sdk/account-core";
import type { TelegramAccountConfig, TelegramActionConfig } from "alien/plugin-sdk/config-types";
import { formatSetExplicitDefaultInstruction } from "alien/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "alien/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ALIEN_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AlienConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AlienConfig): string {
...
export function listEnabledTelegramAccounts(cfg: AlienConfig): ResolvedTelegramAccount[] {
