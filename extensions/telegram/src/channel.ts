...
import type { ChannelMessageActionAdapter } from "alien/plugin-sdk/channel-contract";
import {
...
} from "alien/plugin-sdk/outbound-send-deps";
import { type RoutePeer } from "alien/plugin-sdk/routing";
import {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as AlienConfig;
