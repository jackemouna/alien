...
export function shouldShowTelegramDmAccessWarning(cfg: AlienConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`alien config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`alien config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
