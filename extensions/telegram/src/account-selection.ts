...
function listConfiguredAccountIds(cfg: AlienConfig): string[] {
...
function listBoundAccountIds(cfg: AlienConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: AlienConfig, channelId: string): string | null {
...
export function resolveDefaultTelegramAccountSelection(cfg: AlienConfig): {
  accountId: string;
  accountIds: string[];
