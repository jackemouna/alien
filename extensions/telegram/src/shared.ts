import { resolveNormalizedAccountEntry } from "alien/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "alien/plugin-sdk/channel-core";
import { getChatChannelMeta } from "alien/plugin-sdk/channel-plugin-common";
 ...
 *
 * See: https://github.com/alien/alien/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: AlienConfig, accountId: string): boolean {
