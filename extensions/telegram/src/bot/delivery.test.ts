...
vi.mock("alien/plugin-sdk/hook-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("alien/plugin-sdk/hook-runtime")>();
  return {
    ...actual,
    triggerInternalHook,
  };
...
vi.mock("alien/plugin-sdk/plugin-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("alien/plugin-sdk/plugin-runtime")>();
  return {
    ...actual,
