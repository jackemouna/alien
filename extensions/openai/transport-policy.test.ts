import type { ProviderRuntimeModel } from "alien/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-alien-turn-id": "turn-123",
        "x-alien-turn-attempt": "2",
      },
      metadata: {
        alien_session_id: "session-123",
        alien_turn_id: "turn-123",
        alien_turn_attempt: "2",
        alien_transport: "websocket",
      },
    });
  });
