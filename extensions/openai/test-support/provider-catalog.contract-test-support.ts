...
import type { ProviderPlugin } from "alien/plugin-sdk/provider-test-contracts";
...
vi.mock("alien/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("alien/plugin-sdk/provider-catalog-runtime")
  >("alien/plugin-sdk/provider-catalog-runtime");
