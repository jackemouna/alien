import type { MemoryEmbeddingProviderCreateOptions } from "alien/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("alien/plugin-sdk/memory-core-host-engine-embeddings", () => ({
