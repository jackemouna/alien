...
import { resolveClosestSize } from "alien/plugin-sdk/media-generation-runtime";
import {
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.ALIEN_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: AlienConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: AlienConfig | undefined): boolean {
