...
export function registerMantisCli(qa: Command) {
  ...
  mantis
    ...
    .option("--guild-id <id>", "Override ALIEN_QA_DISCORD_GUILD_ID")
    .option("--channel-id <id>", "Override ALIEN_QA_DISCORD_CHANNEL_ID")
  ...
  mantis
    ...
    .option("--gateway-setup", "Start a persistent Alien Slack gateway inside the VNC VM")
