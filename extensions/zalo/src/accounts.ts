...
function mergeZaloAccountConfig(cfg: AlienConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AlienConfig): ResolvedZaloAccount[] {
