...
const originalEnvToken = process.env.ALIEN_TWITCH_ACCESS_TOKEN;
...
describe("setup surface helpers", () => {
  ...
  afterEach(() => {
    if (originalEnvToken === undefined) {
      delete process.env.ALIEN_TWITCH_ACCESS_TOKEN;
    } else {
      process.env.ALIEN_TWITCH_ACCESS_TOKEN = originalEnvToken;
    }
  ...
  describe("defaultAccount setup resolution", () => {
    ...
    it("reports env-token default account setup as configured", async () => {
      process.env.ALIEN_TWITCH_ACCESS_TOKEN = "oauth:fromenv";
