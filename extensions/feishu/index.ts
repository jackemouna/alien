...
function registerFeishuDocTools(api: AlienPluginApi) {
...
function registerFeishuChatTools(api: AlienPluginApi) {
  const register = loadBundledEntryExportSync<(api: AlienPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: AlienPluginApi) {
  const register = loadBundledEntryExportSync<(api: AlienPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: AlienPluginApi) {
  const register = loadBundledEntryExportSync<(api: AlienPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: AlienPluginApi) {
  const register = loadBundledEntryExportSync<(api: AlienPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: AlienPluginApi) {
  const register = loadBundledEntryExportSync<(api: AlienPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
