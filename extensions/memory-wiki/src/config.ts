...
import { mapPluginConfigIssues } from "alien/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type AlienPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: AlienPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".alien", "wiki", "main");
}
