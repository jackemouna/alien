...
} from "alien/plugin-sdk/memory-host-core";
import {
  appendMemoryHostEvent,
  resolveMemoryHostEventLogPath,
} from "alien/plugin-sdk/memory-host-events";
...
describe("syncMemoryWikiBridgeSources", () => {
  ...
  it("imports public memory artifacts and stays idempotent across reruns", async () => {
    ...
    const logLines = (await fs.readFile(path.join(vaultDir, ".alien-wiki", "log.jsonl"), "utf8"))
      .trim()
      .split("\n");
