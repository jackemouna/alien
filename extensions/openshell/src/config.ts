...
import { buildPluginConfigSchema, type AlienPluginConfigSchema } from "alien/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): AlienPluginConfigSchema {
