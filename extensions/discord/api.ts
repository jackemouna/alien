...
// Deprecated compatibility surface for existing @alien/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "alien/plugin-sdk/runtime-group-policy";
