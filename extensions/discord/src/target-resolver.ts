import type { DirectoryConfigParams } from "alien/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "alien/plugin-sdk/messaging-targets";
