...
import { buildPluginBindingApprovalCustomId } from "alien/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/alien-sessions-test.json");
