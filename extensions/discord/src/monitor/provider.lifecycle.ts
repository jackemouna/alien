...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "ALIEN_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "ALIEN_DISCORD_RUNTIME_READY_TIMEOUT_MS";
