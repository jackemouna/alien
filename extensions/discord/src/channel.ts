...
import { sleepWithAbort } from "alien/plugin-sdk/runtime-env";
import {
  createComputedAccountStatusAdapter,
  createDefaultChannelRuntimeState,
} from "alien/plugin-sdk/status-helpers";
import { resolveTargetsWithOptionalToken } from "alien/plugin-sdk/target-resolver-runtime";
...
function resolveDiscordStartupDelayMs(cfg: AlienConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). Alien adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
