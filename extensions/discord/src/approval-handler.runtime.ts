...
import type { ExecApprovalActionDescriptor } from "alien/plugin-sdk/approval-reply-runtime";
...
import { logDebug, logError, normalizeOptionalString } from "alien/plugin-sdk/text-runtime";
