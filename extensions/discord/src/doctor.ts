...
import { collectProviderDangerousNameMatchingScopes } from "alien/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: AlienConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: AlienConfig,
  doctorFixCommand: string,
): { config: AlienConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: AlienConfig): string[] {
