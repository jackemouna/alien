...
vi.mock("alien/plugin-sdk/web-media", () => discordWebMediaMockFactory());
...
let loadWebMedia: typeof import("alien/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("alien/plugin-sdk/web-media"));
