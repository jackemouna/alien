...
vi.mock("alien/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("alien/plugin-sdk/routing")>(
    "alien/plugin-sdk/routing",
  );
  return {
    ...actual,
...
vi.mock("alien/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("alien/plugin-sdk/agent-runtime")>(
    "alien/plugin-sdk/agent-runtime",
  );
  return {
    ...actual,
