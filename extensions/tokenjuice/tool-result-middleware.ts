...
} from "alien/plugin-sdk/agent-harness";
import { createTokenjuiceAlienEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: AlienAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<AlienAgentToolResult> | void> | Partial<AlienAgentToolResult> | void;
