export { getChatChannelMeta, type ChannelPlugin } from "alien/plugin-sdk/core";
...
export { normalizeE164 } from "alien/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "alien/plugin-sdk/config-types";
import type { AlienConfig as RuntimeAlienConfig } from "alien/plugin-sdk/config-types";

export { type ChannelMessageActionName } from "alien/plugin-sdk/channel-contract";
...
export type AlienConfig = RuntimeAlienConfig;
