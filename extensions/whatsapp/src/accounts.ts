...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "alien/plugin-sdk/config-types";
import { resolveOAuthDir } from "alien/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: AlienConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AlienConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AlienConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AlienConfig): ResolvedWhatsAppAccount[] {
