...
function areWhatsAppAgentReactionsEnabled(params: { cfg: AlienConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: AlienConfig) {
