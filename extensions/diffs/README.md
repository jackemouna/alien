...
Read-only diff viewer plugin for **Alien** agents.
...
Before:
Alien supports plugins.

After:
Alien supports plugins and hosted diff views.
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/alien-diffs`).
