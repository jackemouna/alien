...
const providerFilter = parseCsvFilter(process.env.ALIEN_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ALIEN_LIVE_MUSIC_GENERATION_MODELS);
