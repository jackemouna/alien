...
export const slackChannelConfigUiHints = {
  ...
  "socketMode.clientPingTimeout": {
    ...
    help: "Milliseconds the Slack SDK waits for a pong after its client ping before treating the websocket as stale (Alien default: 15000). Increase on hosts with event-loop starvation or slow network scheduling.",
  },
  ...
  execApprovals: {
    ...
    help: "Slack-native exec approval routing and approver authorization. When unset, Alien auto-enables DM-first native approvals if approvers can be resolved for this workspace account.",
  },
  ...
  "execApprovals.approvers": {
    ...
    help: "Slack user IDs allowed to approve exec requests for this workspace account. Use Slack user IDs or user targets such as `U123`, `user:U123`, or `<@U123>`. If you leave this unset, Alien falls back to commands.ownerAllowFrom when possible.",
  },
