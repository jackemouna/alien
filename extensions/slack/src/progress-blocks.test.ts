      ...
      lines: [
        {
          ...
          icon: "🛠️",
          label: "Exec",
          detail: "run tests in /Users/example/Projects/alien/packages/very/deep/path/example",
          text: "🛠️ Exec: run tests in /Users/example/Projects/alien/packages/very/deep/path/example",
        },
      ],
    });
