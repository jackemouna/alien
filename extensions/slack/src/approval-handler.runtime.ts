...
import { buildApprovalInteractiveReplyFromActionDescriptors } from "alien/plugin-sdk/approval-reply-runtime";
import type { ExecApprovalRequest } from "alien/plugin-sdk/approval-runtime";
import type { AlienConfig } from "alien/plugin-sdk/config-types";
import { logError, normalizeOptionalString } from "alien/plugin-sdk/text-runtime";
import {
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<AlienConfig["channels"]>["slack"]>["execApprovals"]
>;
