...
vi.mock("alien/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("alien/plugin-sdk/channel-inbound")>(
    "alien/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
