...
// Prefix for Alien-generated action IDs to scope our handler
const ALIEN_ACTION_PREFIX = "alien:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${ALIEN_ACTION_PREFIX}`);

  // Handle Alien modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
