...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<AlienConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<AlienConfig["channels"]>["slack"]>>,
): AlienConfig {
  return {
    channels: {
      slack: {
