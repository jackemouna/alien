...
function mergeZalouserAccountConfig(cfg: AlienConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AlienConfig; accountId?: string | null }) {
