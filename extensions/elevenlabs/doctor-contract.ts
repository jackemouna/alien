import type { ChannelDoctorLegacyConfigRule } from "alien/plugin-sdk/channel-contract";
import type { AlienConfig } from "alien/plugin-sdk/config-types";
import { isRecord } from "alien/plugin-sdk/text-runtime";
...
export function normalizeCompatibilityConfig({ cfg }: { cfg: AlienConfig }): {
  config: AlienConfig;
  changes: string[];
} {
