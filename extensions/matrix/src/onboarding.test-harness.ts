import type { OutputRuntimeEnv } from "alien/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "alien/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Alien Gateway",
    },
    confirm: {
