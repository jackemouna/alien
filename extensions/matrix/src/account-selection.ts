...
import { hasConfiguredSecretInput } from "alien/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: AlienConfig): Record<string, unknown> | null {
