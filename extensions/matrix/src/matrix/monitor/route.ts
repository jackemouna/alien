import { resolveConfiguredAcpBindingRecord } from "alien/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "alien/plugin-sdk/session-binding-runtime";
