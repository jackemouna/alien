import { callGatewayTool } from "alien/plugin-sdk/agent-harness-runtime";
import type {
  AnyAgentTool,
  AlienPluginApi,
...
export function createRemindTool(
  toolContext: AlienPluginToolContext = {},
...
export function registerRemindTool(api: AlienPluginApi): void {
