import { resolveClaudeThinkingProfile } from "alien/plugin-sdk/provider-model-shared";
import type { ModelProviderConfig } from "alien/plugin-sdk/provider-model-types";
import {
