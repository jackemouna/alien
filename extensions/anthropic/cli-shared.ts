...
// steer Alien-managed Claude CLI runs toward a different provider,
...
function isAlienRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isAlienRequestedYolo(context)
