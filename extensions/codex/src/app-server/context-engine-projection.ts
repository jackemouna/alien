import type { AgentMessage } from "alien/plugin-sdk/agent-harness-runtime";
...
const CONTEXT_HEADER = "Alien assembled context for this turn:";
...
/**
 * Project assembled Alien context-engine messages into Codex prompt inputs.
 */
