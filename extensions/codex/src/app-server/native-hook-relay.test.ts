import type { NativeHookRelayRegistrationHandle } from "alien/plugin-sdk/agent-harness-runtime";
          ...
          hooks: [
            {
              type: "command",
              command:
                "alien hooks relay --provider codex --relay-id relay-1 --event pre_tool_use",
              timeout: 7,
              async: false,
              statusMessage: "Alien native hook relay",
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              type: "command",
              command:
                "alien hooks relay --provider codex --relay-id relay-1 --event post_tool_use",
              timeout: 7,
              async: false,
              statusMessage: "Alien native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "alien hooks relay --provider codex --relay-id relay-1 --event permission_request",
              timeout: 7,
              async: false,
              statusMessage: "Alien native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "alien hooks relay --provider codex --relay-id relay-1 --event before_agent_finalize",
              timeout: 7,
              async: false,
              statusMessage: "Alien native hook relay",
            },
...
function createRelay(): NativeHookRelayRegistrationHandle {
  return {
    ...
    commandForEvent: (event) =>
      `alien hooks relay --provider codex --relay-id relay-1 --event ${event}`,
