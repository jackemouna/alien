...
import type { HarnessContextEngine as ContextEngine } from "alien/plugin-sdk/agent-harness-runtime";
...
describe("maybeCompactCodexAppServerSession", () => {
  beforeEach(async () => {
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "alien-codex-compact-"));
  });
