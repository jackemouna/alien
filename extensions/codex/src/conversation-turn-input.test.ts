...
describe("codex conversation turn input", () => {
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaPath: "file:///tmp/Alien%20QA/photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "/tmp/Alien QA/photo.png" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrls: ["/tmp/staged-photo.png", "file:///tmp/Alien%20QA/second.jpg"],
      ...
      { type: "localImage", path: "/tmp/Alien QA/second.jpg" },
    ]);
  });
  ...
  it("treats Windows media paths as Codex local image input", () => {
    expect(
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "C:\\Alien QA\\photo.png" },
    ]);
  });
});
