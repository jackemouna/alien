...
vi.mock("alien/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("alien/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
