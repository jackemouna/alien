import type { ChannelSetupAdapter, AlienConfig } from "alien/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "alien/plugin-sdk/setup";
...
export function isLineConfigured(cfg: AlienConfig, accountId: string): boolean {
