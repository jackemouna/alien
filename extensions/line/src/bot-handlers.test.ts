...
vi.mock("alien/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("alien/plugin-sdk/channel-pairing", () => ({
...
vi.mock("alien/plugin-sdk/command-auth", () => ({
...
vi.mock("alien/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("alien/plugin-sdk/group-access", () => ({
...
vi.mock("alien/plugin-sdk/routing", () => ({
