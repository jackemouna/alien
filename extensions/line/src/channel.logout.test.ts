import { createRuntimeEnv } from "alien/plugin-sdk/plugin-test-runtime";
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { AlienConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: AlienConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: AlienConfig; accountId: string }): Promise<{
