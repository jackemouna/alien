...
import { collectIssuesForEnabledAccounts } from "alien/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: alien channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
