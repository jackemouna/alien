...
This package contains the **BlueBubbles external channel plugin** for Alien.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `alien/plugin-sdk` helpers.
