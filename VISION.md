...
Alien is the AI that actually does things.
...
Alien started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Clawdbot -> Moltbot -> Alien.
...
Security in Alien is a deliberate tradeoff: strong defaults without killing capability.
...
Alien has an extensive plugin API.
...
- Code plugins run Alien plugin code and are appropriate for deeper runtime extension.
...
Alien docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
Alien supports MCP as both a server and a runtime integration surface.
...
Alien is currently terminal-first by design.
...
Alien is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep Alien hackable by default.
