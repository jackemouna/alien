import type { GatewayEvent, JsonObject, AlienEvent, AlienEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): AlienEventType {
...
function normalizeAgentEventType(payload: JsonObject): AlienEventType {
...
function normalizeNamedEventType(event: GatewayEvent): AlienEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): AlienEvent {
  const payload = asRecord(event.payload);
