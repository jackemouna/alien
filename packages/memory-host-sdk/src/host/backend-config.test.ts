...
import type { AlienConfig } from "./config-utils.js";
...
const rootMemoryConfig = (workspaceDir: string): AlienConfig =>
  ({
    agents: {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as AlienConfig;
