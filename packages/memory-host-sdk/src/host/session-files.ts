...
import { createSubsystemLogger, redactSensitiveText } from "./alien-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "alien:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Alien-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/alien/alien/issues/63921
 */
